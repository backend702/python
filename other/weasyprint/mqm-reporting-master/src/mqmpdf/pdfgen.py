...
class PdfGenerator:
    ...
    """
    OVERLAY_LAYOUT = '@page {size: A4 landscape; margin: 0; padding: 0}'
    ...
    def _compute_overlay_element(self, element: str):
        ...
        element_doc = html.render(stylesheets=[CSS(string=self.OVERLAY_LAYOUT), os.path.abspath(os.path.join(os.path.dirname(__file__), 'static', 'header.css'))])
